...
export default function ConfidenceBadge({ value = 0.72, label = 'Prediction Confidence' }: Props) {
  ...
  const ring = pct >= 75 ? 'ring-emerald-500/30' : pct >= 55 ? 'ring-yellow-500/30' : 'ring-red-500/30';

  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0c1222] ring-1 ${ring}`}>
