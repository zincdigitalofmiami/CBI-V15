 ...
 */
function HeatmapEmbed({ width = "100%", height = 400, market = "forex" }: HeatmapEmbedProps) {
  ...
  return (
    <div className="bg-[#131722] rounded-lg border border-[#2a2f3e] overflow-hidden">
      <TradingViewWidget scriptSrc={scriptSrc} config={config} height={height} width={width} />
    </div>
  );
}
