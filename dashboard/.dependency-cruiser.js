...
module.exports = {
  forbidden: [
    /* RULES FOR ISOLATION */
    {
      ...
      severity: 'error',
      comment: 'Isolation: Files in app/(pages)/legislation cannot import from app/(pages)/strategy.',
      from: {
    ...
    },
    {
      ...
      severity: 'error',
      comment: 'Isolation: Files in app/(pages)/strategy cannot import from app/(pages)/legislation.',
      from: {
        path: '^app/\\(pages\\)/strategy'
      },
      to: {
