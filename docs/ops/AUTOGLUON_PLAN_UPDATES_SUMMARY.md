...
- **Note Added**: Table definition must be created in `database/definitions/01_raw/epa_rin_prices.sql`
...
1. **`database/definitions/01_raw/epa_rin_prices.sql`**
...
1. **Create `database/definitions/01_raw/epa_rin_prices.sql`** (CRITICAL)
