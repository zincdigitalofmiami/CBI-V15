...
- Create table definition: `database/definitions/01_raw/epa_rin_prices.sql`
...
| `database/definitions/03_features/core_macro_fx.sql` | ✅ **EXISTS** | Confirmed |
...
1. **🔴 CRITICAL**: Fix EPA RIN target table
   ...
   - Create: `database/definitions/01_raw/epa_rin_prices.sql`
...
1. `database/definitions/01_raw/epa_rin_prices.sql` (CRITICAL - referenced in SQL macros)
