...
def plan_training_sweep(horizons: list = None) -> None:
    ...
    # Initialize Bridge (implicitly uses MD token from env)
    # from src.anofox.anofox_bridge import AnofoxBridge
    # bridge = AnofoxBridge()
    # regime = bridge.get_regime("features.daily_ml_matrix_zl_v15")
    ...
    for horizon in horizons:
        job_id = create_job(
            ...
            job_type="training",
            config={"horizon": horizon, "symbol": "ZL", "regime": "adaptive"},
        )
