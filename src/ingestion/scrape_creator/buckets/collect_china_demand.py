...
Fetches China soybean/ag demand news from ScrapeCreators API.
"""
...
BUCKET_ENDPOINT = os.getenv(
    "SCRAPECREATOR_CHINA_ENDPOINT", "https://api.scrapecreator.com/v1/china_demand"
)


def fetch_bucket_items() -> List[Dict[str, Any]]:
    """
    Fetch China demand news items from ScrapeCreators.
