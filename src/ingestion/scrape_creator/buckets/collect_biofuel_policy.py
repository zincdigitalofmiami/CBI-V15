...
Fetches biofuel/RFS policy news from ScrapeCreators API.
"""
...
BUCKET_ENDPOINT = os.getenv(
    "SCRAPECREATOR_BIOFUEL_ENDPOINT", "https://api.scrapecreator.com/v1/biofuel_policy"
)


def fetch_bucket_items() -> List[Dict[str, Any]]:
    """
    Fetch biofuel policy news items from ScrapeCreators.
