#!/usr/bin/env python3
"""
Direct URL Scraper for Premium Sources (DTN, ProFarmer, Jacobsen, etc.)
...
class DirectURLScraper:
    ...
    def _login_dtn(self, session: requests.Session):
        ...
        payload = {
            "username": self.dtn_username,
            "password": self.dtn_password
        }
    ...
    def _login_jacobsen(self, session: requests.Session):
        ...
        payload = {
            "email": self.jacobsen_username,
            "password": self.jacobsen_password
        }
    ...
    def scrape_url(self, url: str, source: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "source": source,
            "published_at": date_elem.get('datetime') if date_elem and date_elem.has_attr('datetime') else datetime.utcnow().isoformat(),
