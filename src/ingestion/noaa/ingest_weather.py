...
Usage:
    python src/ingestion/noaa/ingest_weather.py --start-date 2020-01-01 --end-date 2024-12-31
    python src/ingestion/noaa/ingest_weather.py --backfill  # Download all historical data
"""
