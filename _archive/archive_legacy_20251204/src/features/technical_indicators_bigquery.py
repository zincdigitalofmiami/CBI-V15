...
def create_technical_indicators_table():
    ...
    # Load UDFs (legacy, from archived Dataform includes)
    udf_sql = Path(__file__).parent.parent.parent / "archive" / "legacy_v14" / "dataform" / "includes" / "technical_indicators_udf.sqlx"
