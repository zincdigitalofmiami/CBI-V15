...
SERVICE_ACCOUNTS=("cbi-v15-functions" "cbi-v15-run")
...
APIS=("bigquery.googleapis.com" "cloudscheduler.googleapis.com" "secretmanager.googleapis.com")
for api in "${APIS[@]}"; do
...
# Dataform repository checks skipped (Dataform deprecated).
...
echo ""
echo "Next steps:"
echo "1. Store API keys: ./scripts/setup/store_api_keys.sh"
echo "2. Deploy Cloud Functions (if using)"
echo "3. Create Cloud Scheduler jobs: ./scripts/deployment/create_cloud_scheduler_jobs.sh"
