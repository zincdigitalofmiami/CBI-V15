...
echo ""
echo "Next steps:"
echo "1. Ensure BigQuery datasets exist (raw, staging, features, training, forecasts, api, reference, ops)."
echo "2. Run local ingestion + feature scripts on the Mac (Python-first ETL)."
echo "3. Verify training.daily_ml_matrix in BigQuery before training."
