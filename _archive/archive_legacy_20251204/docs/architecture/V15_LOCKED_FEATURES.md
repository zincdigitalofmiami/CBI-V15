...
**Implementation**: Python in `src/features/build_daily_ml_matrix.py` (replaces legacy Dataform SQL)
...
**Implementation**: Python in `src/features/build_daily_ml_matrix.py` (FX features) and `src/features/build_fx_indicators_daily.py`
...
**Implementation**: Python feature builders (to be implemented) following the same naming contracts
