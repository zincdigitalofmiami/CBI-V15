...
## Step 4: (Deprecated) Dataform

Dataform is no longer part of the active architecture. Python-first ETL and BigQuery SQL views are now canonical for all staging, feature, and training tables.
...
bq mk --dataset --location=us-central1 --description="Staged normalized data" cbi-v15:staging
