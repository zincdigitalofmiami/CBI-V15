...
echo -e "  1. Ingest market data: python src/ingestion/databento/collect_daily.py"
echo -e "  2. Ingest FRED data: python src/ingestion/fred/collect_fred_rates_curve.py"
echo -e "  3. Ingest EIA data: python src/ingestion/eia_epa/collect_eia_biofuels.py"
