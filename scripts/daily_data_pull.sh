#!/bin/bash
# Daily Data Pull - NO ORCHESTRATOR, NO CLOUD SERVICES
...
python src/ingestion/scrapecreators/collect_all_scrapecreators.py

# 4. Weather (US stations)
echo "[4/4] Weather..."
python src/ingestion/weather/pull_weather_now.py
